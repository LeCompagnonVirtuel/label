...
export default function CTASection({
  ...
  return (
    <section className={`py-20 ${dark ? 'bg-navy' : 'bg-gradient-to-r from-orange to-orange-light'}`}>
        ...
        <AnimatedSection>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <a
              ...
              className="flex items-center gap-2 bg-white text-navy hover:bg-gray-100 px-8 py-4 rounded-xl font-semibold text-lg transition-all hover:scale-105"
            >
              <Phone size={20} />
              Appeler maintenant
            </a>
            ...
            <Link
              to="/devis"
              className="flex items-center gap-2 bg-navy hover:bg-navy-light text-white px-8 py-4 rounded-xl font-semibold text-lg transition-all hover:scale-105"
            >
              <FileText size={20} />
              Demander un devis
            </Link>
